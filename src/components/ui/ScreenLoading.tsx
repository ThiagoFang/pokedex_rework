...
export const ScreenLoading = () => {
  ...
  if (!isLoading) return;
  return (
    <div className="flex items-center justify-center inset-0 bg-secondary z-50 absolute animate-fade animate-once animate-duration-500 animate-ease-linear">
      <div className="animate-fade-up animate-once animate-duration-1000 animate-ease-linear">
        ...
        <h1 className="font-bold text-white text-lg mt-2">Loading...</h1>
      </div>
    </div>
  )
}
